...
//extern uint8_t message[TRANSMISSION_SIZE];	// external message buffer used to send on/of keyed manchester encoded IR signal
extern uint32_t transmit_message;	// external message buffer used to send on/off keyes manchester encoded IR signal
/* USER CODE END PV */
